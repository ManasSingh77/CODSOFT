...
public class ATM_INTERFACE {
    static Map<Integer, Practice.User> users = new HashMap<>();
    ...
    public static void registerUser() {
        ...
        users.put(accountNumber, new Practice.User(name, address, contactInfo, initialDeposit));
    ...
    private static void loginUser() {
        ...
        Practice.User user = users.get(accountNumber);
        if (user != null) {
    ...
    private static void showMenu(Practice.User user) {
        while (true) {
    ...
    private static void viewAccountDetails(Practice.User user) {
        System.out.println("\nAccount Details");
    ...
    private static void deposit(Practice.User user) {
    ...
    private static void withdraw(Practice.User user) {
    ...
    private static void transferFunds(Practice.User sender) {
        System.out.print("Enter recipient's account number: ");
        int recipientAccountNumber = scanner.nextInt(); // Correctly reading as integer
        scanner.nextLine(); // Consume newline
        Practice.User recipient = users.get(recipientAccountNumber);
        if (recipient != null) {
